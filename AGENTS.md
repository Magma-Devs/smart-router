...
Never commit secrets. Sample config files (`config/smartrouter_examples/smartrouter_lava.yml`) are templates only. Use environment variables for sensitive data like API keys and tokens.
