...
echo "============================================"
echo ""
echo "  # Set SUI_GRPC_URL_2 / SUI_GRPC_URL_3 and re-run with REGENERATE_CONFIG=1,"
echo "  # then send cross-validation headers as gRPC metadata:"
echo "  grpcurl -plaintext \\"
echo "    -H 'lava-cross-validation-max-participants: 2' \\"
echo "    -H 'lava-cross-validation-agreement-threshold: 2' \\"
echo "    -d '{\"sequence_number\":1}' 127.0.0.1:3370 \\"
echo "    sui.rpc.v2.LedgerService/GetCheckpoint"
echo ""
