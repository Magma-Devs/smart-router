...
#
# USAGE
#   scripts/pre_setups/cache/init_smartrouter_eth_valkey_cluster_remote.sh            # bring up + smoke
#   scripts/pre_setups/cache/init_smartrouter_eth_valkey_cluster_remote.sh --status   # cluster + router state
#   scripts/pre_setups/cache/init_smartrouter_eth_valkey_cluster_remote.sh --flush    # delete ONLY this lane's keys
#   scripts/pre_setups/cache/init_smartrouter_eth_valkey_cluster_remote.sh --stop     # stop the router
#
# ENVIRONMENT
...
cat > "$CONFIG_FILE" <<EOF
# GENERATED by scripts/pre_setups/cache/init_smartrouter_eth_valkey_cluster_remote.sh.
