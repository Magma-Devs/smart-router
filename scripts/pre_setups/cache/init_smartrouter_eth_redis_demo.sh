...
#
# USAGE
#   scripts/pre_setups/cache/init_smartrouter_eth_redis_demo.sh          # bring it up
#   RESP_CACHE=off scripts/pre_setups/cache/init_smartrouter_eth_redis_demo.sh
#                                                                  # UC-5 rollback
#   scripts/pre_setups/cache/init_smartrouter_eth_redis_demo.sh --stop   # tear it down
#
...
{
cat <<EOF
# GENERATED by scripts/pre_setups/cache/init_smartrouter_eth_redis_demo.sh — do not edit.
...
UC-5  No RESP infrastructure — its own lane (stop this one first)
  $0 --stop
  scripts/pre_setups/cache/init_smartrouter_eth_lavap_cache.sh
