...
#
# USAGE
#   scripts/pre_setups/cache/init_smartrouter_eth_redis_sentinel.sh             # bring up
#   scripts/pre_setups/cache/init_smartrouter_eth_redis_sentinel.sh --failover  # the demo
#   scripts/pre_setups/cache/init_smartrouter_eth_redis_sentinel.sh --status    # who is master
#   scripts/pre_setups/cache/init_smartrouter_eth_redis_sentinel.sh --stop      # tear down
#
...
cat > "$CONFIG_FILE" <<EOF
# GENERATED by scripts/pre_setups/cache/init_smartrouter_eth_redis_sentinel.sh.
