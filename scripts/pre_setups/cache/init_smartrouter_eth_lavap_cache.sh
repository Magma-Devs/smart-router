...
#
# USAGE
#   scripts/pre_setups/cache/init_smartrouter_eth_lavap_cache.sh          # bring up + check
#   scripts/pre_setups/cache/init_smartrouter_eth_lavap_cache.sh --stop   # tear down
#
...
cat > "$CONFIG_FILE" <<EOF
# GENERATED by scripts/pre_setups/cache/init_smartrouter_eth_lavap_cache.sh.
