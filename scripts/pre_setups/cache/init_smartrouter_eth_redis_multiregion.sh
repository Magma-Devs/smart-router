...
#
# USAGE
#   scripts/pre_setups/cache/init_smartrouter_eth_redis_multiregion.sh          # bring up
#   scripts/pre_setups/cache/init_smartrouter_eth_redis_multiregion.sh --demo   # the story
#   scripts/pre_setups/cache/init_smartrouter_eth_redis_multiregion.sh --status
#   scripts/pre_setups/cache/init_smartrouter_eth_redis_multiregion.sh --stop
#
# ENVIRONMENT
...
write_config() { # $1 = file, $2 = metrics port, $3 = listen port, $4 = read-addresses line (may be empty)
    cat > "$1" <<EOF
# GENERATED by scripts/pre_setups/cache/init_smartrouter_eth_redis_multiregion.sh.
