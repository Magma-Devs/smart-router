...
#
# USAGE
#   scripts/pre_setups/cache/init_smartrouter_eth_redis_oss_remote.sh            # bring up + smoke
#   scripts/pre_setups/cache/init_smartrouter_eth_redis_oss_remote.sh --status   # backend + router state
#   scripts/pre_setups/cache/init_smartrouter_eth_redis_oss_remote.sh --flush    # delete ONLY this lane's keys
#   scripts/pre_setups/cache/init_smartrouter_eth_redis_oss_remote.sh --stop     # stop the router
#
# ENVIRONMENT
...
cat > "$CONFIG_FILE" <<EOF
# GENERATED by scripts/pre_setups/cache/init_smartrouter_eth_redis_oss_remote.sh.
