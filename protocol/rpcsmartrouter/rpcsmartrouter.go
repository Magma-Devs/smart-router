...
func resolveSelectionWeights(flags *pflag.FlagSet) (provideroptimizer.EndpointSelectorConfig, error) {
	config := provideroptimizer.DefaultEndpointSelectorConfig()
...
rpcsmartrouter smartrouter_examples/full_smartrouter_example.yml --cache-be "127.0.0.1:7778" [--debug-relays] --log_level <debug|warn|...>`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			endpointSelectorConfig, err := resolveSelectionWeights(cmd.Flags())
			if err != nil {
				return err
			}
