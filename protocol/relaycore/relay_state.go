...
func NewRelayState(ctx context.Context, protocolMessage chainlib.ProtocolMessage, stateNumber int, relayParser RelayParserInf, archiveStatus *ArchiveStatus) *RelayState {
