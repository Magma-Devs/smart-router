...
// TestNewEndpointSelector tests the creation of a new EndpointSelector
...
func TestNewEndpointSelectorZeroTotalWeightFallsBackToDefaultWeightsButKeepsOtherConfig(t *testing.T) {
	config := EndpointSelectorConfig{
...
func TestNewEndpointSelectorNegativeWeightFallsBackToDefaultWeightsButKeepsOtherConfig(t *testing.T) {
	config := EndpointSelectorConfig{
...
func TestNewEndpointSelectorNaNWeightFallsBackToDefaultWeightsButKeepsOtherConfig(t *testing.T) {
	config := EndpointSelectorConfig{
...
func TestNewEndpointSelectorInfWeightFallsBackToDefaultWeightsButKeepsOtherConfig(t *testing.T) {
	config := EndpointSelectorConfig{
		AvailabilityWeight: 0.3,
		LatencyWeight:      0.3,
		SyncWeight:         0.2,
...
func TestGetConfig(t *testing.T) {
	originalConfig := EndpointSelectorConfig{
		AvailabilityWeight: 0.5,
		LatencyWeight:      0.3,
		SyncWeight:         0.15,
		StakeWeight:        0.05,
	...
	ws := NewEndpointSelector(originalConfig)
...
func TestStrategyDistributedFlattening(t *testing.T) {
	balancedConfig := DefaultEndpointSelectorConfig()
	balancedConfig.Strategy = StrategyBalanced
	balancedWS := NewEndpointSelector(balancedConfig)

	distributedConfig := DefaultEndpointSelectorConfig()
	distributedConfig.Strategy = StrategyDistributed
	distributedWS := NewEndpointSelector(distributedConfig)
