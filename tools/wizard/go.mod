// smart-router config wizard — a Charm-based TUI that builds a smartrouter
// config and runs the local docker compose stack.
//
// SEPARATE module on purpose: the router's go.mod / go.sum stay clean; the
